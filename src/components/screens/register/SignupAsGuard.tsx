...
import { RegisterAsGuard } from '../../../lib/types';
import { useAppContext } from '../../../store/AppContext';
import { api } from '../../../api';
import { capitalizeFirstLetter } from '../../../lib/helpers';

const SignUpAsGuard = ({ signUpAs, setIsSignUpAs }: { signUpAs: string, setIsSignUpAs: any }) => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  } = useForm<RegisterAsGuard>({
    defaultValues: {
      name: '',
      email: '',
      phone: '',
  ...
  const onSubmit = async (data: RegisterAsGuard) => {
    ...
    if (signUpAs == '') {
      ...
      try {
        const userInfo = {
          ...
          homeCoordinates:"24.906957,67.089203",
        ...
        console.log(error, "signUp guard function catch error*************");
